...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterSubWorkshopHandlerFromEndpoint instead.
...
var (
	pattern_SubWorkshop_PaintCar_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "subworkshop", "paint"}, ""))
)
