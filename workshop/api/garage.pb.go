...
var file_api_garage_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x61, 0x72, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x77, 0x6f, 0x72, 0x6b, 0x73,
...
var file_api_garage_proto_depIdxs = []int32{
	...
	1, // 1: tutorial.workshop.Workshop.AcceptCar:input_type -> tutorial.workshop.Car
	2, // 2: tutorial.workshop.Workshop.PaintCar:input_type -> tutorial.workshop.PaintCarRequest
	4, // 3: tutorial.workshop.Workshop.RetrieveCar:input_type -> tutorial.workshop.RetrieveCarRequest
	3, // 4: tutorial.workshop.Workshop.CarPainted:input_type -> tutorial.workshop.PaintFinishedRequest
	5, // 5: tutorial.workshop.Workshop.AcceptCar:output_type -> google.protobuf.Empty
	5, // 6: tutorial.workshop.Workshop.PaintCar:output_type -> google.protobuf.Empty
	1, // 7: tutorial.workshop.Workshop.RetrieveCar:output_type -> tutorial.workshop.Car
	5, // 8: tutorial.workshop.Workshop.CarPainted:output_type -> google.protobuf.Empty
